...
* [3. 💡 주제 선정 배경](#3--주제-선정-배경)
    ...
    * [3.2 기존 솔루션의 한계와 대안](#32-기존-솔루션의-한계와-대안)
    * [3.3 프로젝트 목표](#33-프로젝트-목표)
* [4. 🏗️ 시스템 구축 환경 (System Architecture)](#4-️-시스템-구축-환경-system-architecture)
    * [4.1 기술 선택 이유 (PostgreSQL, GCP)](#41-기술-선택-이유-postgresql-gcp)
    * [4.2 데이터베이스 스키마 설계](#42-데이터베이스-스키마-설계)
* [5. 🔑 운영 환경 변수 및 보안 설정](#5--운영-환경-변수-및-보안-설정)
    * [5.1 주요 환경 변수 요약](#51-주요-환경-변수-요약)
    * [5.2 GCP Secret Manager 연동](#52-gcp-secret-manager-연동)
* [6. 🔄 핵심 워크플로우 설계 (Core Workflow)](#6--핵심-워크플로우-설계-core-workflow)
    * [6.1 AI 기반 트레이딩 챗봇](#61-ai-기반-트레이딩-챗봇)
    * [6.2 투자 제안 및 실행 파이프라인](#62-투자-제안-및-실행-파이프라인)
* [7. 🚨 트러블슈팅 (Troubleshooting)](#7--트러블슈팅-troubleshooting)
* [8. 🚀 한계 및 향후 개선 사항](#8--한계-및-향후-개선-사항)
* [9. 용어 사전](#9-용어-사전)
